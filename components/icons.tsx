...
export const PapyrusManuscriptIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      {/* Scroll outline */}
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 4v16M18 4v16" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 4C8 2, 16 2, 18 4" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M6 20c2 2, 10 2, 12 0" />
      {/* Writing lines */}
      <g strokeWidth="1">
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9 q 2 -1 4 0 t 4 0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12 q 2 1 4 0 t 4 0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 15 q 2 -1 3 0" />
      </g>
    </svg>
);
...
export const HourglassIcon: React.FC<IconProps> = ({ className }) => (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none">
        ...
        <path 
            ...
            d="M5 4h14M5 20h14M7 4C7 9,11 11,12 12C13 11,17 9,17 4M7 20C7 15,11 13,12 12C13 13,17 15,17 20"
        />
        {/* Sand */}
        {/* Top chamber sand (more) */}
        <path 
            fill="currentColor"
            d="M9 9 C9.5 10.5, 11 11, 12 11 S14.5 10.5, 15 9 H9 Z"
        />
        {/* Bottom chamber sand (less) */}
        <path 
            fill="currentColor"
            d="M8 20 H16 C16 18, 14 15, 12 15 S8 18, 8 20 Z"
        />
    </svg>
);
...
export const HeartIcon: React.FC<HeartIconProps> = ({ className, filled }) => (
...
export const GlobeAltIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c1.355 0 2.707-.157 4.008-.445M12 21c-1.355 0-2.707-.157-4.008-.445m16.724-6.255a8.973 8.973 0 00-4.008-.445m-12.716 0a8.973 8.973 0 014.008-.445M12 3c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zM6.75 9.75h10.5M6.75 14.25h10.5" />
    </svg>
);
